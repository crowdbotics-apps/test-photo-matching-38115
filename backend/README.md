...
## Project Structure
    ...
    ├── test_photo_matching_38115  # Django project configurations
...
1. Clone this repo and `cd test_photo_matching_38115`
...
2. Clone this repo and `cd test_photo_matching_38115`
